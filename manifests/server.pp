...
class mysql::server (
  ...
  $install_secret_grep     = $mysql::params::install_secret_grep,
  $install_secret_grep_opt = $mysql::params::install_secret_grep_opt,
  $install_secret_rm       = $mysql::params::install_secret_rm,
